...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('accounts', function (Blueprint $table) {
            ...
            $table->foreignId('teller_id')->nullable()->constrained('users')->onDelete('set null')->comment('ID of the teller who opened the account');
            ...
            $table->timestamps();
            $table->unique(['client_id', 'account_product_id', 'account_number', 'teller_id'], 'unique_account_teller');
        });
    }
