...
interface CreateAccountProductModalProps {
    isOpen: boolean;
    closeModal: () => void;
    initialData?: Partial<AccountProduct>;
}

const CreateAccountProductModal = ({
    isOpen,
    closeModal,
    initialData = {
        name: "",
...
}: CreateAccountProductModalProps) => {
    const [product, setProduct] =
        useState<Partial<AccountProduct>>(initialData);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route("account-products.store"), product as any, {
            onSuccess: () => {
                closeModal();
            },
            onError: (errors) => {
...
export default CreateAccountProductModal;
