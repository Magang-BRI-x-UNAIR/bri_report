...
interface DeleteAccountProductModalProps {
    isOpen: boolean;
    closeModal: () => void;
    product: AccountProduct | null;
}

const DeleteAccountProductModal = ({
    isOpen,
    closeModal,
    product,
}: DeleteAccountProductModalProps) => {
    if (!isOpen || !product) return null;

    const handleDelete = () => {
        router.delete(route("account-products.destroy", product.id), {
            onSuccess: () => {
                closeModal();
            },
        });
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        ...
                                        dan semua data terkait produk ini akan
...
export default DeleteAccountProductModal;
